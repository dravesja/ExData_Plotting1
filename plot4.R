...
# Plot 4 saved as plot4.png is a two-by-two plot containing the the time series of Global active power and
# the time series plot of Voltage in the first row.  The second row contains the time series plot of the three  
# Sub metering observations and a timr series plot of the Global reactive power.
    
par(mfrow=c(2,2))  # establishes the two-by-two display

plot(hpcworkingTime$DateTime, hpcworkingTime$Global_active_power, type="l", xlab = "", 
     ylab = "Global Active Power" )
plot(hpcworkingTime$DateTime, hpcworkingTime$Voltage, type="l", xlab = "datetime", 
     ylab = "Voltage" )
plot(hpcworkingTime$DateTime, hpcworkingTime$Sub_metering_1, type="l", xlab="", ylab="Energy sub metering")
    ...
    legend("topright", col = c("black", "red", "blue"), c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), 
          lty=c(1,1), bty = "n", cex = 0.4)
plot(hpcworkingTime$DateTime, hpcworkingTime$Global_reactive_power, type="l", xlab = "datetime", 
